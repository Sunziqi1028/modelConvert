...
const (
	...
	// ListMaterialType means the user can get the material type list.
	ListMaterialType Authority = "LIST_MATERIAL_TYPE"
	// EditMaterial means the user can edit material name and thumbnail who saved.
	EditMaterial Authority = "EDIT_MATERIAL"
	// EditMaterialType means the user can edit material type name  who saved.
	EditMaterialType Authority = "EDIT_MATERIAL_TYPE"
	// SaveMaterial means the user can save a new material.
	SaveMaterial Authority = "SAVE_MATERIAL"
	// SaveMaterialType means the user can save a new material type.
	SaveMaterialType Authority = "SAVE_MATERIAL_TYPE"
	// DeleteMaterial means the user can delete the material who saved.
	DeleteMaterial Authority = "DELETE_MATERIAL"
	// DeleteMaterialType means the user can delete the material type who saved.
	DeleteMaterialType Authority = "DELETE_MATERIAL_TYPE"
	...
	// ExportMesh .
	ExportMesh Authority = "Export_MESH"
