 ...
 */
function createShaderMaterial(vertexShader, fragmentShader, uniforms, lights) {
 ...
 * @param {*} renderer 渲染器
 */
class ShaderTerrain extends THREE.Mesh {
    constructor(renderer) {
        ...
        var hightMaterial = createShaderMaterial(HeightVertexShader, HeightFragmentShader, heightUniforms, false);
        ...
        var normalMaterial = createShaderMaterial(THREE.NormalMapShader.vertexShader, THREE.NormalMapShader.fragmentShader, normalUniforms, false);
        ...
        var terrainMaterial = createShaderMaterial(terrainShader.vertexShader, terrainShader.fragmentShader, terrainUniforms, true);
        ...
        super(geometry, terrainMaterial);
