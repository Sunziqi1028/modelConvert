 ...
 * 物理地形
 */
class PhysicsTerrain extends THREE.Mesh {
    constructor() {
        // 灰阶高度参数
     ...
     */
    createTerrainShape(terrainWidth, terrainDepth, terrainWidthExtents, terrainDepthExtents, heightData, terrainMinHeight, terrainMaxHeight) {
